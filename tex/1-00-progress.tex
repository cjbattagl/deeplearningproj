...
\item Mid-term project report writing- Chih-Yao Ma, Min-Hung Chen, Hao, Casey
\item Mid-term project presentation- Chih-Yao Ma
\item Read and understand papers on 2D-LSTM - Everyone
%\item Read and understand caffe code that implements 2D-CNN and LSTM.
\item Implement the temporal encoder with LSTM: Chih-Yao Ma
