...
for sp=1,numSplit do
	table.insert(outTrain, {name = 'feat_label_UCF101_train_'..sp..'.t7'})
end

outTest = {}
for sp=1,numSplit do
	table.insert(outTest, {name = 'feat_label_UCF101_test_'..sp..'.t7'})
end
				        ...
				        if numFrame >= numFrameMin then
				           ...
				           --  	end
				          	...
				          	if opt.feat then -- feature extraction
				            	...
				            	local i,j = string.find(videoName,'v_'..nameClass[c]..'_g') -- find the location of the group info in the string
