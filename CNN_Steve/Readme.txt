...
Load one image and predict the label of that image.

command: th classify_video_debug.lua

notes:
1. Now only one model work: "nin_nobn_final.t7" 
2. try to load VGG Caffe models, but the prediction result is really strange.
3. try to load other Torch models, but we need to install "cudnn".
